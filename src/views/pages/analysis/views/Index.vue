<template>
  <div class="page animated fadeIn pgAnalysis">
    ...
    <div v-if="!analysisReady">
      <i class="mdi mdi-tools" style="font-size: 500px"></i>
    </div> -->
    <div class="content-wrapper" v-if="analysisReady">
      <div class="left">
        <div class="left-top">
    ...
    <empty-page v-else :iconType="'work_in_progress'">

      <template slot="content">
        {{ $t("Page Under Construction", {page:$t('Analysis')}) }}
      </template>
    </empty-page>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters("analysis", ["analysisReady"]),
    getTitle() {
      let formattedLabelText = "";
      switch (this.title) {
