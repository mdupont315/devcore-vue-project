...
const getRowControlButtons = (editor) => {
  const container = getElementWithAttributes('div', { class: 'row-control-button-container' })

  for (const el of rowControlButtonsData) {
    const btn = getElementWithAttributes('button', { class: 'table-control-button ' })
...
const getDeleteTableButton = (editor) => {
  ...
  const el = getElementWithAttributes('button', { class: 'delete-table-button' })
...
const getColControlButtons = (editor) => {
  const container = getElementWithAttributes('div', { class: 'col-control-button-container' })
