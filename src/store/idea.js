...
const getters = {
    ...
    byStage: state => stageId => state.all.filter(o => o.parentStructure.stageId === stageId),
    byOperation: state => operationId => state.all.filter(o => o.parentStructure.operationId === operationId),
    byPhase: state => phaseId => state.all.filter(o => o.parentStructure.phaseId === phaseId),
