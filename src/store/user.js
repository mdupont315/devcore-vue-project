...
const getters = {
    ...
    filteredItems: state => state.filter && state.filter.length > 3 ? state.all.filter(i => i.firstName.toLowerCase().includes(state.filter.toLowerCase()) || i.lastName.toLowerCase().includes(state.filter.toLowerCase()) || i.email.toLowerCase().includes(state.filter.toLowerCase())) : state.all,
}
