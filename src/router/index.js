...
const routes = [
  ...
  },
  {
      ...
      component: () =>
          import ( /* webpackChunkName: "forgot-password" */ '@/views/pages/ForgotPassword'),
      meta: {
          middleware: [guest],
          layout: 'external-layout',
      }
  },
  {
      ...
      name: 'reset-password',
      component: () =>
          import ( /* webpackChunkName: "forgot-password" */ '@/views/pages/ResetPassword'),
      meta: {
          middleware: [guest],
          layout: 'external-layout',
      }
  },
  {
      ...
      component: () =>
          import ( /* webpackChunkName: "email-verification" */ '@/views/pages/SendEmailVerification'),
      meta: {
          middleware: [guest],
          layout: 'external-layout',
      }
  },
  {
      ...
      name: 'verify-account',
      component: () =>
          import ( /* webpackChunkName: "email-verification" */ '@/views/pages/VerifyAccount'),
      meta: {
          middleware: [guest],
          layout: 'external-layout',
      }
 ...
 
  {
      ...
      children: [{
          ...
          },
          {
              ...
              name: 'tool-ideas',
              component: () =>
                  import ( /* webpackChunkName: "improve" */ '@/views/pages/improve/tool_ideas/Index'),
              meta: {
                  middleware: [auth],
                  title: 'Tool Ideas',
                  permissions: "improve/idea/manage",
                  titleButton: () =>
                      import ( /* webpackChunkName: "improve" */ '@/views/pages/improve/tool_ideas/TitleButton'),
                  //topRight: () => import(/* webpackChunkName: "improve" */'@/views/pages/manage/proccess/SearchBar'),
                  topCentral: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/improve/tool_ideas/CentralBar'),
              },
          },
      ]
  },
  {
      ...
      children: [{
          ...
          component: () =>
              import ( /* webpackChunkName: "manage" */ '@/views/pages/analysis/general/Index'),
          meta: {
              middleware: [auth],
              title: 'General',
  ...
  },
  {
      ...
      children: [{
              ...
              name: 'support-people',
              component: () =>
                  import ( /* webpackChunkName: "manage" */ '@/views/pages/support/people/Index'),
              meta: {
                  middleware: [auth],
                  title: 'People',
                  permissions: "process/process/manage",
          ...
          },
          {
              ...
              name: 'support-issues',
              component: () =>
                  import ( /* webpackChunkName: "manage" */ '@/views/pages/support/issues/Index'),
              meta: {
                  middleware: [auth],
                  title: 'Issues',
                  permissions: "process/process/manage",
                  // titleButton: () => import(/* webpackChunkName: "manage" */'@/views/pages/manage/proccess/TitleButton'),
                  topRight: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/support/issues/SearchBar'),
                  topCentral: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/support/issues/CentralBar'),
              },
          },
      ]
  },
  {
      ...
      children: [{
              ...
              meta: {
                  ...
                  permissions: "process/process/manage",
                  titleButton: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/proccess/TitleButton'),
                  topRight: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/proccess/SearchBar'),
                  topCentral: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/proccess/CentralBar'),
              },
          },
          {
              path: 'tool',
              ...
              children: [{
                      ...
                      name: 'tool-tool',
                      component: () =>
                          import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/tool/tool/Index'),
                      meta: {
                          middleware: [auth],
                          title: 'Tools',
                          permissions: "core/companyTool/manage",
                          titleButton: () =>
                              import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/tool/tool/TitleButton'),
                          topRight: () =>
                              import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/tool/tool/SearchBar'),
                      },
                  },
          ...
          },
          {
              ...
              name: 'company-role',
              component: () =>
                  import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/company_role/Index'),
              meta: {
                  middleware: [auth],
                  title: 'Employee Role',
                  permissions: "core/companyRole/manage",
                  titleButton: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/company_role/TitleButton'),
                  topRight: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/company_role/SearchBar'),
              },
          },
          {
              path: 'users',
              name: 'company-user',
              component: () =>
                  import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/user/Index'),
              meta: {
                  middleware: [auth],
                  title: 'Users',
                  permissions: "auth/user/manage",
                  titleButton: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/user/TitleButton'),
          ...
          },
          {
              ...
              name: 'project',
              component: () =>
                  import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/project/project/Index'),
              meta: {
                  middleware: [auth],
                  title: 'Projects',
                  ...
                  topRight: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/project/SearchBar'),
                  topCentral: () =>
                      import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/project/CentralBar'),
              },
          },
          {
              path: 'admin-projects',
              name: 'admin-project',
              component: () =>
                  import ( /* webpackChunkName: "manage" */ '@/views/pages/manage/project/admin/Index'),
              meta: {
                  middleware: [auth],
  ...
  },
  {
      ...
      import ( /* webpackChunkName: "home" */ '@/views/pages/manage/proccess/Index'),
